...
export function getDeviceModel() {
    return window.account && window.account.getDeviceModel();
}

export function buyProduct(productId) {
    window.account && window.account.onPayForProduct(productId);
}

/**
 * 打开并分享内容到app
 */
export function shareToApp(app, content) {
    return window.account && window.account.onShare(app, content);
}
...
export function saveLog(log) {
    return window.account && window.account.onSaveLog(log);
}
