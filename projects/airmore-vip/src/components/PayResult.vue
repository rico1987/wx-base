<template>
    <div class="mobile-pay-result" v-show="visible">
        <div class="mobile-pay-result__mask"></div>
        <div class="mobile-pay-result__wrapper">
            <div class="panel">
                <p class="pay-result__title">{{$tr('Please complete the payment in the newly-opened page@@002135')}}</p>
