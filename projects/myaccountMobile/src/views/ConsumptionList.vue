<template>
    <div class="myaccount-consumption-list has-header has-loading">
        <MobileHeader
            defaultLeft
            :title="$t('001854')"
        >
        ...
        <div class="container">
            ...
            <div class="tab-content" @scroll="onscroll()">
                <div class="order-list" v-if="active_tab == 'purchase_records'">
                    ...
                    <p class="no-data" v-if="!loading && (!orderList || orderList.length === 0)">{{ $t('001864') }}</p>
                </div>
                <div class="consumption-list" v-if="active_tab == 'consumption_records'">
                    ...
                    <p class="no-data" v-if="!loading && (!consumptionList || consumptionList.length === 0)">{{ $t('001864') }}</p>
                </div>
            </div>
        </div>
