    ...
    <div class="myaccount-consumption-list has-header">
        ...
        <div class="container">
            <div class="tab-header">
                <div :class="{ 'active':  active_tab == 'purchase_records'}" @click="setActiveTab('purchase_records')">
                    <span>
                        <span class="text">{{ $t('001855') }}</span>
                        <span class="bottom-border"></span>
                    </span>
                </div>
                <div :class="{ 'active':  active_tab == 'consumption_records'}" @click="setActiveTab('consumption_records')">
                    <span>
                        <span class="text">{{ $t('001856') }}</span>
                        <span class="bottom-border"></span>
                    </span>
                </div>
            </div>
