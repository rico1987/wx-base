    ...
    >
        ...
        <div class="account-input__cell">
            ...
            <input
                ...
                ref="input"
            />
            <div class="account-input__tel-input-wrapper" v-if="type === 'tel'">
                <div
                    class="account-input__tel-area-code-selector"
                ...
                <input
                    class="account-input__input is-tel"
                    type="tel"
                    :maxlength="max"
                    :autocomplete="autocomplete"
                    :autocapitalize="autocapitalize"
        ...
        <div class="account-input__right">
            <span
                class="account-input__clear"
                v-if="showClear"
            ...
            <span
                ...
                class="account-input__password-switch"
                :class="{ 'is-show': showPassword }"
                v-if="type === 'password' && showSwitchPassword"
            >
            </span>
            <span class="account-input__right-content" v-if="$slots.right">
